            ...
            <div class="block">
              ...
              <div id="RO" style="text-align:center;width:240px;background:#fff;"><a href="http://fmradio-online.ru/" id="aRO">Онлайн радио</a></div><script type="text/javascript" src="http://fmradio-online.ru/scripts/rns.js" charset="UTF-8"></script>
                         ...
                         $articles = mysqli_query($connection, "SELECT * FROM `articles` ORDER BY `views` DESC LIMIT 5" );
                          ...
                          <article class="article">
                            ...
                            <div class="article__info">
                              ...
                              <div class="article__info__preview"><?php echo mb_substr(strip_tags($art['text']), 0, 50, 'utf-8'). ' ...'; ?>                                  
                              </div>
                            </div>
                          </article>
                      <?php
                         ...
                         $comments = mysqli_query($connection, "SELECT * FROM `comments` ORDER BY `id` DESC LIMIT 5" );
                          ...
                          <article class="article">
                            ...
                            <div class="article__info">
                              ...
                              <div class="article__info__meta"></div>
                              <div class="article__info__preview"><?php echo mb_substr(strip_tags($comment['text']), 0, 50, 'utf-8'). ' ...'; ?>                                  
                              </div>
                            </div>
                          </article>
                      <?php
